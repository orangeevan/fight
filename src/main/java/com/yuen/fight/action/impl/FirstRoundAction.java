 ...
 */
public class FirstRoundAction extends IAction<FirstRoundAction.Board, MwnFightHandler.BoardBox> {
    ...
    @Override
    public void end() {
        System.err.println("FirstRoundAction--end--"+board.round);
    }
    ...
    public void action() {
        ...
        //TODO 战斗逻辑
        System.err.println("FirstRoundAction- action -"+board.round);
    }
