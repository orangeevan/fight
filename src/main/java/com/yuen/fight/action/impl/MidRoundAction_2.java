 ...
 */
public class MidRoundAction_2 extends IAction<MidRoundAction_2.Board, MwnFightHandler.BoardBox> {
    ...
    @Override
    public void end() {
        System.err.println("MidRoundAction_2- end -"+board.round);
    }
    ...
    public void action() {
        ...
        //TODO 战斗逻辑
        System.err.println("MidRoundAction_2- action -"+board.round);
    }
